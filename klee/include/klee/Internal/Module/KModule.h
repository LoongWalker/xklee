...
namespace klee {
  ...
  struct KFunction {
    ...
    //add a map for record basicBlock id 
    std::map<llvm::BasicBlock*, unsigned> basicBlockID;

    /// Whether instructions in this function should count as
    /// "coverable" for statistics and search heuristics.
    bool trackCoverage;
    //  mark it as the focused function addbyxqx
    bool isFocusedFunc;
  ...
  public:
    ...
    unsigned bbNum; //keep record all bb number in moudle, addbyxqx
