...
#ifdef XQX_RESOLVE_DEBUG_OFF 
		std::cerr << "[xqx] resolveOne address is not constant in state[" << state.id <<"]\n";
...
void AddressSpace::printFileLine(ExecutionState &state, KInstruction *ki) {
