...
Statistic stats::instructionTime("InstructionUserTimes", "IUsertime");
...
Statistic stats::coveredFocusedInsts("coveredFocusedInsts", "IFcov");
Statistic stats::uncoveredFocusedInsts("uncoveredFocusedInsts", "IFuncov");
//Statistic stats::instCoveredTimes("instCoveredTimes", "ICovTimes");
