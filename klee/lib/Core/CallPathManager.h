...
namespace klee {
  ...
  public:
    typedef std::map<std::pair<llvm::Instruction*, llvm::Function*>, 
                     CallPathNode*> children_ty;
  ...
  public:
    ...
    CallPathNode *getCallPath(CallPathNode *parent, 
                              llvm::Instruction *callSite,
                              llvm::Function *f);
    //generate called node graph
    void genCallPathNodeGraph(std::ostream *dotFile);
  };
}
